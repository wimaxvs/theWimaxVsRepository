    ...
    <div className="grid items-center max-[991px]:justify-items-start grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-20">
      <div className="max-[991px]:max-w-[720px]">
        ...
        <div className="ml-0 mr-0 mt-4 max-w-[528px] mb-5 md:mb-6 lg:mb-8 pb-4">
          <p className="text-[#636262] max-[479px]:text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus</p>
        </div>
        <div className="mb-4 flex items-center max-[991px]:mb-px">
          <img src="https://assets.website-files.com/6344564e41b7185978bcb175/6344ae2b569e53cbca3db723_star.svg" alt="" className="inline-block mr-1 w-5 pl-0" />
          <img src="https://assets.website-files.com/6344564e41b7185978bcb175/6344ae2b569e53cbca3db723_star.svg" alt="" className="inline-block mr-1 w-5 pl-0" />
          <img src="https://assets.website-files.com/6344564e41b7185978bcb175/6344ae2b569e53cbca3db723_star.svg" alt="" className="inline-block mr-1 w-5 pl-0" />
          <img src="https://assets.website-files.com/6344564e41b7185978bcb175/6344ae2b569e53cbca3db723_star.svg" alt="" className="inline-block mr-1 w-5 pl-0" />
          <img src="https://assets.website-files.com/6344564e41b7185978bcb175/6344ae2b569e53cbca3db723_star.svg" alt="" className="inline-block mr-1 w-5 pl-0" />
        ...
        <div className="mb-8 max-w-[480px]">
          <p className="text-[#636262] max-[479px]:text-sm">Lorem ipsum dolor sit amet, &nbsp;elit ut aliquam, purus sit amet luctus venenatis elit ut aliquam, purus sit amet luctus venenatis</p>
        </div>
        <div className="flex-row flex items-start">
          <img src="https://assets.website-files.com/6458c625291a94a195e6cf3a/6458c625291a945e53e6cf8f_Ellipse%2011%20(1).svg" alt="" className="inline-block h-16 w-16 object-cover mr-4" />
