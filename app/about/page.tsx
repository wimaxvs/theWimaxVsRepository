    ...
    <div className="flex items-stretch max-[991px]:min-h-[auto] max-[991px]:w-full max-[991px]:flex-col grid-cols-1 lg:grid-cols-[65%_30%] gap-8 lg:gap-20">
      <div className="flex-col flex-1 flex justify-center gap-8">
        ...
        <div className="flex items-center justify-start gap-4 flex-wrap">
          <a href="#" className="inline-block items-center bg-black px-6 py-3 text-center font-semibold text-white">Learn More</a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4">
          <div className="flex-col flex w-full items-start justify-between gap-4 border border-solid bg-[#f2f2f7] rounded-md p-6 md:p-4">
            <div className="text-sm sm:text-sm">I have been using the Business Solution services for the past year, and I am extremely satisfied with the results. Their innovative solutions and expertise have transformed my business operations.</div>
            <div className="flex items-center gap-x-4 text-left max-[767px]:w-full max-[479px]:gap-2">
              <div className="flex items-center gap-x-2">
                <img src="https://assets.website-files.com/624380709031623bfe4aee60/6243807090316203124aee66_placeholder-image.svg" alt="" className="flex h-12 min-h-[48px] w-12 min-w-[48px] items-center rounded-[100%] object-cover" />
                <p className="font-semibold max-[479px]:text-sm">Alleyah</p>
              </div>
              <div className="w-px bg-[#636262] h-5">
              </div>
              <div className="flex items-center gap-x-2">
                ...
                <div className="flex text-[#f6ad1b]">
                  <div className="flex-col flex h-4 w-4 items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className="" width="100%" height="100%" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
