...
const page = async () => {
  return (
    <>
      <div
        className={`profilPage w-full min-h-screen flex flex-row justify-center py-10 bg-[url('/images/bkg_profil.jpg')] bg-no-repeat bg-cover bg-left-bottom overflow-y-scroll`}
      >
        <section
