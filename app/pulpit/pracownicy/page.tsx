...
const page = async () => {
  ...
  return (
    <div className="bg-[url('/images/bkg_6.webp')] bg-no-repeat bg-cover bg-left-bottom h-screen w-full min-h-full flex flex-row justify-center pt-6">
      <section
