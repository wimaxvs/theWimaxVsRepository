...
const page = async () => {
  ...
  let currentDriver = {
    ...theCurrentDriver,
    id: theCurrentDriver?.id || "",
    firmId: theCurrentDriver?.firmId || null,
    balance: theCurrentDriver?.balance || 0,
  };
  ...
  return (
    <div className="bg-[url('/images/rozliczenia2.jpg')] bg-no-repeat bg-cover bg-left-bottom h-screen w-full min-h-full flex flex-row justify-center pt-6">
      <section
