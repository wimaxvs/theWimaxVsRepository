...
const Carousel:React.FC<CarouselProps> = ({task, detailComponent}) => {
  return (
    <div className="carousel w-full">
      <div id={`slide1_${task?.id}`} className="carousel-item relative w-full">
        <div className={`flex flex-row gap-3 w-11/12 flex-wrap justify-start`}>
          {[
            {
      ...
      <div id={`slide2_${task?.id}`} className="carousel-item relative w-full">
        <Image
          width={700}
          height={700}
      ...
      <div id={`slide3_${task?.id}`} className="carousel-item relative w-full">
        <Image
          width={700}
          height={700}
